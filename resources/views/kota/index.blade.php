...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('kota.create') }}" class="btn btn-primary shadow-sm">
                <i class="bx bx-plus me-1"></i> Tambah kota
            </a>
        </div>
        ...
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-header bg-white border-0 py-3 px-4 mt-2">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="card-title mb-0 fw-semibold">Daftar Kota</h5>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="text-muted small fw-bold">{{ $row->nama_provinsi }}</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="fw-bold text-dark fs-6">{{ $row->nama_kota }}</span>
                                        </div>
                                    </td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end shadow border-0 py-2">
                                                <a class="dropdown-item text-primary py-2"
                                                    href="{{ route('kota.edit', $row->id_kota) }}">
                                                    <i class="bx bx-edit-alt me-2"></i> Edit kota
                                                </a>
                                                <div class="dropdown-divider"></div>
                                                <form action="{{ route('kota.destroy', $row->id_kota) }}" method="POST"
                                                    class="m-0">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="button"
                                ...
                                <tr>
                                    <td colspan="4" class="text-center py-5">
                                        <div class="text-muted">
                                            ...
                                            <p class="mb-0">Belum ada data kota yang terdaftar.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
