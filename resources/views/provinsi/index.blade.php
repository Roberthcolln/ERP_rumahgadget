            ...
            <div class="col-md-8 col-lg-6">
                <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                    ...
                    <div class="bg-primary p-4 text-center">
                        ...
                        <h5 class="text-white mb-0 fw-bold">Informasi Provinsi</h5>
                    ...
                    <div class="card-body p-4">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                        <div>
                                            <small class="text-muted d-block text-uppercase fw-semibold mb-1"
                                                style="font-size: 0.7rem; letter-spacing: 1px;">Nama Provinsi</small>
                                            <h4 class="mb-0 text-dark fw-bold">{{ $row->nama_provinsi }}</h4>
                                        </div>
                        ...
                        <div class="d-grid">
                            @foreach ($provinsi as $row)
                                <a href="{{ route('provinsi.edit', $row->id_provinsi) }}"
                                    class="btn btn-primary btn-lg shadow">
                                    <i class="bx bx-edit-alt me-2"></i> Perbarui Data Provinsi
                                </a>
                            @endforeach
                        </div>
                    </div>
                ...
                <div class="text-center mt-3 text-muted">
                    <small><i class="bx bx-lock-alt me-1"></i> Data provinsi bersifat tunggal dan tidak dapat dihapus untuk
